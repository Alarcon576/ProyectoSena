        ...
        <div className="perfil-card">
          ...
          {user.descripcion ? (
            ...
            <p className="perfil-bio perfil-bio--vacia">
              ...
              <span
                style={{ color: "var(--orange, #ff7a00)", cursor: "pointer", fontWeight: 700 }}
          ...
          {esMiPerfil ? (
            <button className="btn-edit-profile" onClick={() => setMostrarModal(true)}>
              Editar perfil
            </button>
          ) : (
            ...
            <div className="perfil-adopciones">
              {loadingSolicitudes ? (
                <div className="perfil-empty">
                  <div className="adopt-spinner" /><p>Cargando...</p>
                </div>
                  ...
                  return (
                    <div className="solicitud-card" key={sol.id_solicitud}>
                      ...
                      <div className="solicitud-right">
                        <span className="solicitud-estado" style={{ color: cfg.color, background: cfg.bg }}>
                          {cfg.label}
                        </span>
                        {sol.estado?.toLowerCase() === "pendiente" && (
                          <button className="solicitud-cancelar" onClick={() => cancelarSolicitud(sol.id_solicitud)}>
                            Cancelar
                          </button>
                        )}
                      </div>
