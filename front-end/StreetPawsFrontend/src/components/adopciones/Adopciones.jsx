...
/* Texto del botón para mascotas no disponibles — empático */
...
function Adopciones({ onSwitch, user }) {
  ...
  const mascotasFiltradas = mascotas.filter(m => {
    ...
    return (
      ...
      (filtroEdad === "Todos" ||
        clasificarEdad(m.edad) === filtroEdad) &&
  ...
  return (
    <>
      ...
      <nav className="ad-navbar">
        <div className="ad-nav-brand" onClick={() => onSwitch("feed")}>
          Street Paws
        </div>
        ...
        <div className="ad-nav-right">
          <div
            className="ad-nav-avatar-wrapper"
            onClick={e => {
              e.stopPropagation();
            ...
            {menuAvatarAbierto && (
              <div className="ad-dropdown-avatar">
                <div className="ad-dropdown-header">
                  <span className="ad-dropdown-nombre">
                    {usuarioActual?.nombre || "Usuario"}
                  </span>

                  <span className="ad-dropdown-email">
                    {usuarioActual?.email || ""}
                  </span>
                </div>
        ...
        <>
          <section className="adopt-top-cta">
            <div className="adopt-top-cta-inner">
              <span className="adopt-top-cta-eyebrow">
              ...
              <p>
                Agrega, edita y administra los animales en adopción,
                y revisa las solicitudes de la comunidad.
              </p>
            </div>
          </section>
          ...
          <div className="admin-tabs">
            <button
              className={`admin-tab ${
                tabAdmin === "mascotas" ? "admin-tab--active" : ""
              }`}
            ...
            <button
              className={`admin-tab ${
                tabAdmin === "solicitudes" ? "admin-tab--active" : ""
              }`}
        ...
        >
          ...
          >
            ...
            <div className="adopt-modal-img-wrap">
              ...
              <span
                className={`adopt-badge-modal ${
                  getBadge(mascotaSeleccionada.estado_adopcion).cls
                }`}
              >
            ...
            <div className="adopt-modal-info">
              ...
              <p className="adopt-modal-sub">
                {getEdadTexto(mascotaSeleccionada.edad)} · {mascotaSeleccionada.raza}
              </p>
          ...
          <section className="adopt-top-cta">
            <div className="adopt-top-cta-inner">
              ...
              <p>
                ...
                Dale un hogar definitivo a una mascota de la calle hoy
                y siente el amor incondicional.
              </p>
          ...
          <div className="adopt-page">
              ...
              <div className="adopt-filters-top">
                <h2 className="adopt-filters-title">
                  ...
                  {mascotasOrdenadas.length > 0 && (
                    <span className="adopt-count-badge">
                      {mascotasOrdenadas.length}
                    </span>
                  )}
                </h2>
            ...
            {hayFiltros && (
              <div className="adopt-active-filters">
                {filtroEspecie !== "Todos" && (
                  <span className="adopt-filter-chip">
                    {filtroEspecie}
                    <button onClick={() => setFiltroEspecie("Todos")}>✕</button>
                  </span>
                )}
                ...
                {filtroEdad !== "Todos" && (
                  <span className="adopt-filter-chip">
                    {filtroEdad}
                    <button onClick={() => setFiltroEdad("Todos")}>✕</button>
                  </span>
                )}
                ...
                {filtroGenero !== "Todos" && (
                  <span className="adopt-filter-chip">
                    {filtroGenero}
                    <button onClick={() => setFiltroGenero("Todos")}>✕</button>
                  </span>
                )}
                  ...
                  return (
                    <div
                      className={`adopt-card ${
                        !disponible ? "adopt-card--nodisponible" : ""
                      }`}
                    ...
                    >
                      ...
                      <div className="adopt-card-body">
                        ...
                        {mascota.especie && (
                          <span className="adopt-card-especie-pill">
                            {mascota.especie}
                          </span>
                        )}
            ...
            <div className="adopt-footer-inner">
              <div className="adopt-footer-brand">
                ...
                <p>
                  ...
                  amorosos. Tu adopción puede salvar una vida y traerte alegría.
                </p>
