...
function Perfil({ onSwitch, userId }) {
  ...
  const totalAdoptados = solicitudes.filter(
    (s) => s.estado?.toLowerCase() === "aprobada",
  ).length;
      ...
      <div className="perfil-container">
        ...
        <div className="perfil-card">
          ...
          <p className="perfil-bio">
            Amante de los animales y rescatista voluntario.
            <br />
            Comprometido con encontrar el hogar perfecto para cada pelucito
            callejero.
          </p>
          {esMiPerfil ? (
            <button
                  ...
                  return (
                    <div className="favorito-card" key={id_mascota}>
                      <div className="favorito-img">
                        ...
                        <span
                          className={`fav-badge ${disponible ? "fav-badge--disponible" : "fav-badge--no"}`}
                        >
